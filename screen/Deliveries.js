  ...
  return (
    <KeyboardAvoidingView
      ...
      <View className="bg-white  " style={{ height: "90%" }}>
        <View className="px-2 h-24 bg-green-500 mx-2 mb-4 rounded-xl">
          <View className="py-2 ">
      ...
      <TouchableOpacity>
        <View className=" bg-green-500 py-2 mt-4 mx-2 rounded-xl">
          <Text className="text-center text-white font-semibold">Deliver</Text>
        </View>
      </TouchableOpacity>
    </KeyboardAvoidingView>
  );
